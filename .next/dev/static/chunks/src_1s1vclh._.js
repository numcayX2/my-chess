...
const useGameStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        colorChoice: "white",
        elo: 1200,
        game: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chess$2e$js$2f$dist$2f$esm$2f$chess$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chess"](),
        fen: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chess$2e$js$2f$dist$2f$esm$2f$chess$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chess"]().fen(),
        history: [],
        analysis: {
            evalCp: 0,
            mate: null,
        ...
        startGame: (choice, elo)=>{
            ...
            const game = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chess$2e$js$2f$dist$2f$esm$2f$chess$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chess"]();
            set({
                phase: "playing",
        ...
        makeMove: (from, to, promotion = "q")=>{
            ...
            try {
                ...
                set({
                    fen: game.fen(),
                    hint: null
                }); // เคลียร์คำใบ้เก่าทุกครั้งที่มีการเดินจริง
                get().checkGameOver();
                return true;
            } catch  {
                return false;
        ...
        useHint: ()=>{
            const { hint, hintsRemaining, analysis, phase } = get();
            if (phase !== "playing" || hintsRemaining <= 0) return;
            // ลองใช้ bestMoveUci ก่อน ถ้าไม่มีให้ดึงจาก Principal Variation (pv) ตาแรก
            const bestUci = analysis.bestMoveUci || analysis.pv?.[0];
            // ถ้า Stockfish ยังวิเคราะห์ไม่เสร็จจริง ๆ ให้ข้ามไป (ยังไม่ตัดจำนวน hintsRemaining)
            if (!bestUci || bestUci.length < 4) return;
            const from = bestUci.slice(0, 2);
            const to = bestUci.slice(2, 4);
            // คำใบ้ใหม่ (ตำแหน่งเปลี่ยนไปแล้ว หรือยังไม่เคยขอ) เริ่มที่ระดับ 1
            if (!hint || hint.from !== from || hint.to !== to) {
                set({
                    hint: {
                        level: 1,
                        from,
            ...
            // เดิมอยู่ระดับ 1 แล้ว กดซ้ำ = อัปเกรดเป็นระดับ 2
            if (hint.level === 1) {
                set({
                    hint: {
                        level: 2,
        ...
        undoLastFullMove: ()=>{
            const { game, phase, playerColor } = get();
            if (phase !== "playing") return;
            const verbose = game.history({
                verbose: true
            });
            if (verbose.length === 0) return;
            // ถ้าตอนนี้เป็นตาผู้เล่น (แปลว่า AI เพิ่งเดินตอบ) ต้องย้อน 2 ครึ่งตา
            // ถ้าเป็นตา AI (แปลว่าผู้เล่นเพิ่งเดิน AI ยังไม่ทันตอบ) ย้อนแค่ 1
            const pliesToUndo = game.turn() === playerColor ? Math.min(2, verbose.length) : 1;
            for(let i = 0; i < pliesToUndo; i++)game.undo();
            set((s)=>({
                    fen: game.fen(),
                    history: s.history.slice(0, Math.max(0, s.history.length - pliesToUndo)),
                    hint: null,
                    advice: {
                        text: "",
                        loading: false
...
"[project]/src/components/SetupModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SetupModal() {
    _s();
    const startGame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "SetupModal.useGameStore[startGame]": (s)=>s.startGame
    }["SetupModal.useGameStore[startGame]"]);
    const [choice, setChoice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("white");
    const [elo, setElo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1200);
    const modalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const contentRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const magneticBtnRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const colorRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const eloRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Entry animation
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "SetupModal.useGSAP": ()=>{
            const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].context({
                "SetupModal.useGSAP.ctx": ()=>{
                    ...
                    // Color cards pop
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(colorRefs.current.filter(Boolean), {
                        opacity: 0,
                        y: 12,
                        scale: 0.95
                    }, {
            ...
            }["SetupModal.useGSAP.ctx"], modalRef);
            return ({
                "SetupModal.useGSAP": ()=>ctx.revert()
            })["SetupModal.useGSAP"];
        }
    }["SetupModal.useGSAP"], []);
    ...
    const handleColorSelect = (idx, value)=>{
        ...
        if (btn) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(btn, {
                scale: 0.95
            }, {
                scale: 1,
                duration: 0.15,
    ...
    const handleEloChange = (value)=>{
        setElo(value);
        if (eloRef.current) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(eloRef.current, {
                scale: 1.1,
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: COLOR_OPTIONS.map((opt, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ref: (el)=>{
                  ...
                  `,
                                            ...
                                            children: [
                                                choice === opt.value && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SetupModal, "qXPUB6Nl+lD00JF2YXh1cI2lys8=", false, function() {
    return [
...
_c = SetupModal;
var _c;
__turbopack_context__.k.register(_c, "SetupModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/stockfishClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/moveClassifier.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CLASS_COLOR = {
    ...
    book: "border-[var(--foreground-dim)] text-[var(--foreground-dim)] bg-transparent font-medium"
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/chessUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function uciToSan(uci, fen) {
    ...
    try {
        const temp = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chess$2e$js$2f$dist$2f$esm$2f$chess$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chess"](fen);
...
"[project]/src/hooks/useGameEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/gameStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stockfishClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/stockfishClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/moveClassifier.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chessUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/chessUtils.ts [app-client] (ecmascript)");
...
function useGameEngine() {
    _s();
    const phase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "useGameEngine.useGameStore[phase]": (s)=>s.phase
    }["useGameEngine.useGameStore[phase]"]);
    const fen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "useGameEngine.useGameStore[fen]": (s)=>s.fen
    }["useGameEngine.useGameStore[fen]"]);
    const elo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "useGameEngine.useGameStore[elo]": (s)=>s.elo
    }["useGameEngine.useGameStore[elo]"]);
    const processedFenRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const isEngineThinkingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const prevAnalysisRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        fen: fen,
        evalCp: 20,
        mate: null,
        bestMoveUci: null
    });
    // 1. Warm up Stockfish engine
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGameEngine.useEffect": ()=>{
            if (phase === "playing") {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stockfishClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStockfish"])().waitUntilReady();
            }
        }
    }["useGameEngine.useEffect"], [
        phase
    ]);
    // 2. Reset tracking when new game starts
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGameEngine.useEffect": ()=>{
            if (phase === "playing") {
                processedFenRef.current = null;
                isEngineThinkingRef.current = false;
    ...
    // 3. Game Engine Controller Loop
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGameEngine.useEffect": ()=>{
            if (phase !== "playing") return;
            if (processedFenRef.current === fen || isEngineThinkingRef.current) return;
            let isSubscribed = true;
            isEngineThinkingRef.current = true;
            ({
                "useGameEngine.useEffect": async ()=>{
                    try {
                        const store = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"].getState();
                        const engine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stockfishClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStockfish"])();
                        const game = store.game;
                        const verboseHistory = game.history({
                            verbose: true
                        });
                        const lastMove = verboseHistory[verboseHistory.length - 1];
                        // --- PHASE A: Analyze current position ---
                        store.setAnalysis({
                            thinking: true
                        });
                        const info = await engine.analyze(fen, 12, {
                            "useGameEngine.useEffect": (partial)=>{
                                if (isSubscribed) store.setAnalysis(partial);
                            }
                        }["useGameEngine.useEffect"]);
                        if (!isSubscribed) return;
                        const bestMoveSanNow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chessUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uciToSan"])(info.bestMoveUci, fen);
                        store.setAnalysis({
                            ...info,
                            bestMoveSan: bestMoveSanNow,
                            thinking: false
                        });
                        // --- PHASE B: Evaluate Last Move & Request Ollama Advice ---
                        if (lastMove) {
                            ...
                            const classification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classifyMove"])(moverColor, prev.evalCp, prev.mate, info.evalCp, info.mate, wasBest);
                            store.pushEvalPoint({
                            ...
                            // Fetch Advice for Player Move
                            if (moverColor === store.playerColor) {
                                const bestMoveSanBefore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chessUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uciToSan"])(prev.bestMoveUci, prev.fen);
                                store.setAdvice({
                                    loading: true
                                });
                                try {
                                    const text = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ollama$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMoveAdvice"])({
                                        fen,
                                    ...
                                    if (isSubscribed) store.setAdvice({
                                        text,
                                        loading: false
                                    });
                                } catch (err) {
                        ...
                        // Mark current FEN as completely processed before AI move
                        processedFenRef.current = fen;
                        // --- PHASE C: Execute Opponent AI Move ---
                        const isGameOver = game.isGameOver();
                        const isAITurn = game.turn() !== store.playerColor;
                        if (!isGameOver && isAITurn && isSubscribed) {
                            const uci = await engine.getEngineMove(fen, elo, 500);
                            if (uci && isSubscribed) {
                                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"].getState().applyEngineMove(uci);
                            }
                        }
                    } catch (error) {
                        console.error("Game engine processing error:", error);
                    } finally{
                        isEngineThinkingRef.current = false;
                    }
                }
    ...
    function onDrop({ sourceSquare, targetSquare }) {
        ...
        const moveSuccess = store.makeMove(sourceSquare, targetSquare, "q");
        if (moveSuccess) {
            // ล้างค่า Hint เมื่อเดินสำเร็จ
            if (store.clearHint) {
                store.clearHint();
            } else {
                store.setHint?.(null);
    ...
    function undo() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stockfishClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStockfish"])().stop();
        isEngineThinkingRef.current = false;
        processedFenRef.current = null;
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"].getState().undoLastFullMove();
    }
    function resign() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stockfishClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStockfish"])().stop();
        isEngineThinkingRef.current = false;
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"].getState().resign();
    }
    return {
        onDrop,
        undo,
...
_s(useGameEngine, "HtzzRSACLUNaKAPwmvtWxsMiWM0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"]
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@gsap/react/src/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/gameStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGameEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useGameEngine.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Board() {
    _s();
    const fen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "Board.useGameStore[fen]": (s)=>s.fen
    }["Board.useGameStore[fen]"]);
    ...
    const squareStyles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Board.useMemo[squareStyles]": ()=>{
            ...
            // 5. HINT HIGHLIGHTS (วางไว้ท้ายสุดเสมอ)
            if (hint) {
                styles[hint.from] = {
                    ...styles[hint.from],
                    boxShadow: "inset 0 0 0 4px #00f0ff, 0 0 10px #00f0ff",
                    backgroundColor: "rgba(0, 240, 255, 0.35)"
                };
                if (hint.level === 2 && hint.to) {
                    styles[hint.to] = {
                        ...styles[hint.to],
                        boxShadow: "inset 0 0 0 4px #a3e635, 0 0 10px #a3e635",
...
"[project]/src/components/EvalBar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EvalBar() {
    _s();
    const analysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "EvalBar.useGameStore[analysis]": (s)=>s.analysis
    }["EvalBar.useGameStore[analysis]"]);
    ...
    const prevPctRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(50);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EvalBar.useEffect": ()=>{
            if (labelRef.current) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(labelRef.current, {
                    scale: 1.2,
                    color: "var(--accent-hazard)"
                }, {
                    scale: 1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "EvalBar.useGSAP": ()=>{
            if (analysis.thinking && barRef.current) {
                const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].context({
                    "EvalBar.useGSAP.ctx": ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(barRef.current, {
                ...
                }["EvalBar.useGSAP.ctx"], barRef);
                return ({
                    "EvalBar.useGSAP": ()=>ctx.revert()
                })["EvalBar.useGSAP"];
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    analysis.thinking && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            hasMate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(EvalBar, "2YTSQiJlP5pLEeferF0FJmfEsak=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"]
    ];
...
_c = EvalBar;
var _c;
__turbopack_context__.k.register(_c, "EvalBar");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/AdvicePanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdvicePanel() {
    _s();
    const advice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "AdvicePanel.useGameStore[advice]": (s)=>s.advice
    }["AdvicePanel.useGameStore[advice]"]);
    const history = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "AdvicePanel.useGameStore[history]": (s)=>s.history
    }["AdvicePanel.useGameStore[history]"]);
    const playerColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "AdvicePanel.useGameStore[playerColor]": (s)=>s.playerColor
    }["AdvicePanel.useGameStore[playerColor]"]);
    ...
    const prevTextRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("");
    // Text scramble/reveal animation when advice changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdvicePanel.useEffect": ()=>{
            if (advice.text && textRef.current && advice.text !== prevTextRef.current) {
                ...
                const interval = setInterval({
                    "AdvicePanel.useEffect.interval": ()=>{
                        element.textContent = finalText.split("").map({
                            "AdvicePanel.useEffect.interval": (char, index)=>{
                                if (index < iteration) return finalText[index];
                                if (char === " " || char === "\n") return char;
                                return chars[Math.floor(Math.random() * chars.length)];
                            }
                        }["AdvicePanel.useEffect.interval"]).join("");
                ...
                }["AdvicePanel.useEffect.interval"], 25);
                return ({
                    "AdvicePanel.useEffect": ()=>clearInterval(interval)
                })["AdvicePanel.useEffect"];
            }
        }
    }["AdvicePanel.useEffect"], [
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    lastPlayerPoint?.classification && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ref: badgeRef,
                        className: `notation text-[10px] uppercase tracking-wider px-2.5 py-0.5 border-2 transition-colors duration-150 ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_COLOR"][lastPlayerPoint.classification]}`,
                        style: {
                            clipPath: "polygon(0 0, calc(100% - 4px) 0, 100% 4px, 100% 100%, 4px 100%, 0 calc(100% - 4px))"
                        },
                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_LABEL_TH"][lastPlayerPoint.classification]
                    }, void 0, false, {
                        fileName: "[project]/src/components/AdvicePanel.tsx",
                        lineNumber: 86,
                        columnNumber: 11
            ...
            lastPlayerPoint && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: advice.loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 116,
                    columnNumber: 11
                }, this) : advice.text ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ref: textRef,
...
_s(AdvicePanel, "oPngRjyh5eIepV7TylI0cjLAZHM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"]
...
_c = AdvicePanel;
var _c;
__turbopack_context__.k.register(_c, "AdvicePanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/MoveList.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MoveList() {
    _s();
    const history = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "MoveList.useGameStore[history]": (s)=>s.history
    }["MoveList.useGameStore[history]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoveList.useEffect": ()=>{
            ...
            if (lastRow) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(lastRow, {
                    opacity: 0,
                    x: -8,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "MoveList.useGSAP": ()=>{
            if (rowRefs.current.length > 0 && listRef.current) {
                const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].context({
                    "MoveList.useGSAP.ctx": ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(rowRefs.current.filter(Boolean), {
                            opacity: 0,
                            y: 4
                        }, {
                            opacity: 1,
                ...
                }["MoveList.useGSAP.ctx"], listRef);
                return ({
                    "MoveList.useGSAP": ()=>ctx.revert()
                })["MoveList.useGSAP"];
            }
        }
    }["MoveList.useGSAP"], []);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    rows.map((row, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ref: (el)=>{
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: row.white?.classification ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_COLOR"][row.white.classification] : "text-[var(--foreground)]",
                                    children: row.white?.san ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "flex items-center gap-1.5",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: row.black?.classification ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_COLOR"][row.black.classification] : "text-[var(--foreground)]",
                                    children: row.black?.san ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "flex items-center gap-1.5",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(MoveList, "3iZkhiNGLgZokviNyFXARXHKWuI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"]
    ];
...
_c = MoveList;
var _c;
__turbopack_context__.k.register(_c, "MoveList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/GameSummary.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GameSummary() {
    _s();
    const history = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[history]": (s)=>s.history
    }["GameSummary.useGameStore[history]"]);
    const playerColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[playerColor]": (s)=>s.playerColor
    }["GameSummary.useGameStore[playerColor]"]);
    const gameOverReason = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[gameOverReason]": (s)=>s.gameOverReason
    }["GameSummary.useGameStore[gameOverReason]"]);
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[summary]": (s)=>s.summary
    }["GameSummary.useGameStore[summary]"]);
    const setSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[setSummary]": (s)=>s.setSummary
    }["GameSummary.useGameStore[setSummary]"]);
    const resetToSetup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameSummary.useGameStore[resetToSetup]": (s)=>s.resetToSetup
    }["GameSummary.useGameStore[resetToSetup]"]);
    const requestedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GameSummary.useMemo[chartData]": ()=>history.map({
                "GameSummary.useMemo[chartData]": (p, idx)=>({
                        ply: idx + 1,
                        eval: Math.max(-800, Math.min(800, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toComparable"])(p.evalAfter, p.mateAfter))),
                        san: p.san
                    })
            }["GameSummary.useMemo[chartData]"])
    }["GameSummary.useMemo[chartData]"], [
        history
    ]);
    const flagged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GameSummary.useMemo[flagged]": ()=>history.filter({
                "GameSummary.useMemo[flagged]": (p)=>p.byColor === playerColor && p.classification && [
                        "mistake",
                        "blunder",
                        "inaccuracy"
                    ].includes(p.classification)
            }["GameSummary.useMemo[flagged]"])
    }["GameSummary.useMemo[flagged]"], [
        history,
        playerColor
    ]);
    async function generateSummary() {
        ...
        try {
            const store = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"].getState();
            const text = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ollama$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchGameSummary"])({
                pgn: store.game.pgn(),
                playerColor,
                moves: history.map((h)=>({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "GameSummary.useGSAP": ()=>{
            const activeSections = sectionsRef.current.filter({
                "GameSummary.useGSAP.activeSections": (el)=>el !== null
            }["GameSummary.useGSAP.activeSections"]);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        ...
                        summary?.loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                flagged.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        flagged.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: flagged.map((p, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chessUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uciToSan"])(p.bestMoveBefore, p.fenBefore) ?? "-"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/GameSummary.tsx",
                                                            lineNumber: 351,
                                                            columnNumber: 23
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `shrink-0 notation text-[10px] font-black px-2.5 py-1 border-2 uppercase ${p.classification ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_COLOR"][p.classification] : ""}`,
                                            children: p.classification ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moveClassifier$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_LABEL_TH"][p.classification] : ""
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/GameSummary.tsx",
                                            lineNumber: 358,
                                            columnNumber: 19
...
_s(GameSummary, "fX4dr83b6yaG+sAjX7da65m81+8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
...
_c = GameSummary;
var _c;
__turbopack_context__.k.register(_c, "GameSummary");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function GameControls() {
    _s();
    const phase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[phase]": (s)=>s.phase
    }["GameControls.useGameStore[phase]"]);
    const historyCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[historyCount]": (s)=>s.history.length
    }["GameControls.useGameStore[historyCount]"]);
    const hint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[hint]": (s)=>s.hint
    }["GameControls.useGameStore[hint]"]);
    const hintsRemaining = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[hintsRemaining]": (s)=>s.hintsRemaining
    }["GameControls.useGameStore[hintsRemaining]"]);
    const bestMoveUci = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[bestMoveUci]": (s)=>s.analysis.bestMoveUci
    }["GameControls.useGameStore[bestMoveUci]"]);
    const useHintAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "GameControls.useGameStore[useHintAction]": (s)=>s.useHint
    }["GameControls.useGameStore[useHintAction]"]);
    const { undo, resign } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useGameEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameEngine"])();
    const canUndo = phase === "playing" && historyCount > 0;
    const canHint = phase === "playing" && hintsRemaining > 0 && !!bestMoveUci && hint?.level !== 2;
    const canResign = phase === "playing";
    function handleResign() {
        if (window.confirm("ยืนยันว่าต้องการยอมแพ้เกมนี้ใช่ไหม? การกระทำนี้ย้อนกลับไม่ได้")) {
            resign();
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: undo,
                disabled: !canUndo,
                className: "tactical-btn notation text-[11px] px-3 py-2 disabled:opacity-30 disabled:cursor-not-allowed",
                children: "[ ↺ ย้อนตา ]"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                disabled: !canResign,
                className: "tactical-btn notation text-[11px] px-3 py-2 text-[var(--accent-crimson)] disabled:opacity-30 disabled:cursor-not-allowed",
                children: "[ ยอมแพ้ ]"
            }, void 0, false, {
                fileName: "[project]/src/components/GameControls.tsx",
                lineNumber: 49,
...
_s(GameControls, "LsfCN2g486190OapE3m//3BJS4k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@gsap/react/src/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/gameStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SetupModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/SetupModal.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$EvalBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/EvalBar.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AdvicePanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/AdvicePanel.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MoveList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MoveList.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GameSummary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/GameSummary.tsx [app-client] (ecmascript)");
...
function Home() {
    _s();
    const phase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "Home.useGameStore[phase]": (s)=>s.phase
    }["Home.useGameStore[phase]"]);
    const elo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "Home.useGameStore[elo]": (s)=>s.elo
    }["Home.useGameStore[elo]"]);
    const playerColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "Home.useGameStore[playerColor]": (s)=>s.playerColor
    }["Home.useGameStore[playerColor]"]);
    const resetToSetup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"])({
        "Home.useGameStore[resetToSetup]": (s)=>s.resetToSetup
    }["Home.useGameStore[resetToSetup]"]);
    const mainRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const headerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
            ...
            if (phase === "playing" && mainRef.current) {
                const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].context({
                    "Home.useGSAP.ctx": ()=>{
                        ...
                        if (gridChildren) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(gridChildren, {
                                opacity: 0,
                                y: 16,
                                scale: 0.98
                            }, {
    ...
    if (phase === "setup") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SetupModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/src/app/page.tsx",
        lineNumber: 68,
        columnNumber: 33
    }, this);
    if (phase === "finished") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GameSummary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/src/app/page.tsx",
        lineNumber: 69,
        columnNumber: 36
    }, this);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-2",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GameControls$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 120,
                                columnNumber: 11
                            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$EvalBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 137,
                            columnNumber: 11
                        }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Board$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 143,
                                columnNumber: 13
                            }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AdvicePanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                    fileName: "[project]/src/app/page.tsx",
                                    lineNumber: 151,
                                    columnNumber: 13
                                }, this)
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MoveList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                    fileName: "[project]/src/app/page.tsx",
                                    lineNumber: 156,
                                    columnNumber: 13
                                }, this)
...
_s(Home, "TXunEmwNHrVt7wg5hY4C28NDNOQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$gameStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameStore"],
...
//# sourceMappingURL=src_1s1vclh._.js.map